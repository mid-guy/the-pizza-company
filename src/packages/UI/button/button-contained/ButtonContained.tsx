...
} from "./button-contained-primary/getButtonContainedPrimaryCss";
import getButtonContainedPrimaryCss from "./button-contained-primary/getButtonContainedPrimaryCss";
...
const ButtonBase = forwardRef<HTMLButtonElement, OverallButtonBaseProps>(
  function (props, ref) {
    ...
    const scopeButtonBaseClasses = generateButtonContainedPrimaryClassNames({
      root: true,
    });

    const scopeButtonBaseCSS = getButtonContainedPrimaryCss(theme, props);
...
ButtonBase.displayName = RUI_BUTTON_CONTAINED_PRIMARY;
